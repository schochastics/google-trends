...
In this tutorial, you will learn how to obtain data from [Google trends](https://trends.google.com)[^1] using the R package 
...
The tutorial is written with `r R.version$version.string` which comes with a native 
pipe operator `|>`. If you are using an R version 3.x, you need to substitute it with `%>%`.
